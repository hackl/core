#!/usr/bin/python -tt
# -*- coding: utf-8 -*-
# Time-stamp: <Tue 2013-09-10 11:42 juergen>
...
def main():
  ...
  # Save data to file
  filename_1 = 'dat/failure/failure.dat'
  ...
  if os.path.isfile(filename_1):
    prob_failure = np.loadtxt(filename_1)
  else:
      ...
      for hum in val_hum:
        ...
        for chloride in val_chloride:
          ...
          for dia in val_dia:
            ...
            # print resistance.getBeta()

            j +=1
            k +=1
          i += 1
    np.savetxt(filename_1,prob_failure)
  ...
  net.addNodes(nodes)
  path = os.path.expanduser('~/Dropbox/core/SM_failure.xdsl')
  net.writeFile(path)
